...
map.getView().fit([8515521.562315, 1081937.041486, 8672199.765009, 1169685.743492], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MUNNAR_ADMINISTRATIVE_BOUNDARY</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (77 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Munnar Grama Panchayat is located in the Idukki district of Kerala, India.<br /><br /><br />';
            }
